...
$data = [
  ...
  'type' => [
    'en' => [
      '0' => [
        'target_id' => "3f3a3d8a-3ff2-4e87-b543-bf484bd32093",
      ],
    ],
    'ko' => [
      '0' => [
...
$expectations['d1aee8f8-e868-496d-a8f7-5b9a8df2de7e'] = new CdfExpectations($data, ['nid', 'vid', 'revision_log', 'revision_translation_affected', 'path']);
$data = [
  'uuid' => [
    'en' => [
      '0' => [
        'value' => "376a9b53-3c5e-485b-9bc7-288f940842bc",
      ],
    ],
  ],
  'preferred_langcode' => [
...
$expectations['376a9b53-3c5e-485b-9bc7-288f940842bc'] = new CdfExpectations($data, []);
$data = [
  'uuid' => [
    'en' => [
      '0' => [
