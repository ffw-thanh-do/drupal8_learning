...
class ContentHubStatusReportTest extends EntityKernelTestBase {
  ...
  public function testContentHubStatusReportWithNoClients() {
    ...
    $client->searchEntity($options)->willReturn([]);
  ...
  public function testContentHubStatusReportWithClients() {
    ...
    $client = $this->getClient();
    $client->searchEntity($options)->willReturn(MockDataProvider::searchResponse());

    // Hardcoded responses for each webhook. See MockDataProvider::searchResponse().
    $client->getInterestsByWebhook('00000000-55aa-42f5-50d1-2e35b72ae26d')->willReturn([]);
    $client->getInterestsByWebhook('00000000-4b0b-4c99-5b1d-0177597c2ca7')->willReturn(['00000000-12bc-442f-46f5-d2694d553429']);
    $client->getInterestsByWebhook('00000000-72b6-4df8-710b-59790112588e')->willReturn(['00000000-42bf-4860-6d03-4e3411ee32b4']);
    $client->getInterestsByWebhook('00000000-5ac3-4e9f-7fe9-776b56a389c0')->willReturn(['00000000-9987-4b2a-74b9-d758c8b60d12']);
