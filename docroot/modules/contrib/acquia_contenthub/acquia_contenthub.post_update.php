...
function acquia_contenthub_post_update_update_config_entities() {
  ...
  // Make sure existing webhook for the site in 1.x is unregistered from Content Hub.
  $state = \Drupal::state();
  $webhook_uuid = $state->get('acquia_contenthub_update_8201_webhook_uuid', NULL);
  ...
  $state->delete('acquia_contenthub_update_8201_webhook_uuid');
}
/**
