...
class AcquiaContentHubCommands extends DrushCommands {
   ...
   *   The module extension list.
   */
  public function __construct(DependencyCalculator $calculator, EntityCDFSerializer $serializer, ConfigFactoryInterface $config_factory, ClientFactory $client_factory, ModuleExtensionList $module_list) {
